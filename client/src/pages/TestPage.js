...
const TestPage = () => {
    ...
    const predefinedImages = [
        { id: 1, src: process.env.PUBLIC_URL + '/Test1.jpeg', originalCaption: 'Original Caption for Test 1' },
        { id: 2, src: process.env.PUBLIC_URL + '/Test2.jpeg', originalCaption: 'Original Caption for Test 2' },
        { id: 3, src: process.env.PUBLIC_URL + '/Test3.jpeg', originalCaption: 'Original Caption for Test 3' }
    ];
