...
const TestDL = () => {
    ...
    const predefinedImages = [
        { id: 1, src: process.env.PUBLIC_URL + '/Test1.jpeg', originalPRED: 'Original Caption for Test 1' },
        { id: 2, src: process.env.PUBLIC_URL + '/Test2.jpeg', originalPRED: 'Original Caption for Test 2' },
        { id: 3, src: process.env.PUBLIC_URL + '/Test3.jpeg', originalPRED: 'Original Caption for Test 3' }
    ];
